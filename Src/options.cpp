...
bool Options::VERBOSE = 0;
bool Options::use_RMAT = 0;
char* Options::dumpname = NULL;
char* Options::rootname = NULL;

double Options::A = A_PARAM;
double Options::B = B_PARAM;
double Options::C = C_PARAM;
double Options::D = 1.0 - (A_PARAM + B_PARAM + C_PARAM);

int Options::NBFS = NBFS_max;
...
bool Options::isUseMat()
{
	return Options::use_RMAT;
}

char* Options::getDumpname()
{
	return Options::dumpname;
}

char* Options::getRootname()
{
	return Options::rootname;
}
...
void Options::setNbfs(int m)
{
	Options::NBFS = m;
}

int64_t Options::getScale()
{
	return Options::SCALE;
}

int64_t Options::getEdgefactor()
{
	return Options::edgefactor;
}
