...
void
permute_vertex_labels (struct packed_edge * __restrict  IJ, int64_t nedge, int64_t max_nvtx,
               mrg_state * __restrict  st, int64_t * __restrict  newlabel)
{
  int64_t k;
...
void
permute_edgelist (struct packed_edge * __restrict  IJ, int64_t nedge, mrg_state *st)
{
